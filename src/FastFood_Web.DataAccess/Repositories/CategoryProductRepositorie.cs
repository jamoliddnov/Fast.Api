...
{
    public class CategoryProductRepositorie : GenericRepositorie<CategoryProduct>, ICategoryProductRepositorie
    {
        public CategoryProductRepositorie(AppDbContext dbContext) : base(dbContext)
        {
        }
    }
}
